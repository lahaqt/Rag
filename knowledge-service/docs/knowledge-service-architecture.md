...
This module is the knowledge service for the RAG agent. It merges the previous
...
The knowledge service starts a single consumer thread in the `storage-indexers`
...
Start the knowledge-service infrastructure:
