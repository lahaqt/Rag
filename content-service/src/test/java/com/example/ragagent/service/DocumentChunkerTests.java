...
class DocumentChunkerTests {
    ...
    private ContentProperties properties(String strategy, int chunkSize, int chunkOverlap) {
        return new ContentProperties(
                Path.of("data/knowledge-bases"),
                chunkSize,
                chunkOverlap,
                new ContentProperties.Chunking(strategy, chunkSize, chunkOverlap, 20, List.of("\n\n", "\n", "。", "，", " ", "")),
                null,
                null,
                null,
                null,
