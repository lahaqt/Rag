...
public class DocumentChunker {
    ...
    public DocumentChunker(ContentProperties properties) {
        this.properties = properties;
    }

    public List<DocumentChunk> chunk(String materialId, String documentName, String courseId, String text) {
        String normalized = normalize(text);
        if (normalized.isBlank()) {
            return List.of();
        }

        ContentProperties.Chunking chunking = properties.chunking();
    ...
    private List<String> hybridChunks(String documentName, String text, ContentProperties.Chunking chunking) {
    ...
    private List<String> qaChunks(String text, ContentProperties.Chunking chunking) {
    ...
    private List<String> recursiveChunks(String text, ContentProperties.Chunking chunking) {
