...
@Component
@ConditionalOnProperty(prefix = "content.vector.embedding", name = "provider", havingValue = "openai")
public class OpenAiEmbeddingClient implements EmbeddingClient {
    ...
    public OpenAiEmbeddingClient(
        ...
        if (embedding.apiKey().isBlank()) {
            throw new IllegalStateException("content.vector.embedding.api-key is required when provider is openai.");
        }
